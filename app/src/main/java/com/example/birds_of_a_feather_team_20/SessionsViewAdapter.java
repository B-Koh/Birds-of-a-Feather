...
//public class SessionsViewAdapter extends RecyclerView.Adapter<CoursesViewAdapter.ViewHolder> {
...
//        return return this.sessions.size();;
//    }
//
...
//            intent.putExtra("session_profiles", this.session.getSessionWithProfilesAndCourses());
